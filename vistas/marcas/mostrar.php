...
<a href="?ctrl=CtrlMarca&accion=nuevo" class="btn btn-primary"> Nueva Carta</a>
...
<a href="#" id="imprimir1" class="btn btn-success">Imprimir AutoTabla</a>
    ...
    <?php  
        ...
        <tr>
            <td><?=$d['id']?></td>
            <td><?=$d['nombre']?></td>
            <td><a href="?ctrl=CtrlMarca&accion=editar&id=<?=$d['id']?>"> Editar</a></td>
            <td><a href="?ctrl=CtrlMarca&accion=eliminar&id=<?=$d['id']?>"> Eliminar</a></td>
        </tr>
        <?php } ?>
    </table>
<p></p>
